...
Tab1:AddDiscordInvite({
    ...
    Logo = "rbxassetid://131149676605839",
    Invite = "https://discord.gg/WEnkcs5Vq",
})

local Section = Tab1:AddSection({"Credits"})

local Paragraph = Tab1:AddParagraph({"Criador", "Nickzinpae"})

local Paragraph = Tab1:AddParagraph({"Versão", "1.1.0"})
...
--// Aba Admin
local AdminTab = Window:MakeTab({"Admin 🛠️", "hammer"}) -- ícone de tool

--» Painel Admin
local PainelAdminSection = AdminTab:AddSection({"» Painel Admin"})

-- Dropdown Painel Admin
local selectedPainelAdmin = nil
local painelDropdown = AdminTab:AddDropdown({
Name = "Painel Admin",
Description = "Somente quem comprou funciona",
Options = {"Painel admin NICK HUB"},
Default = nil,
Callback = function(v) selectedPainelAdmin = v end
})

-- Botão para executar painel
AdminTab:AddButton({
Name = "Executar Painel",
Callback = function()
if selectedPainelAdmin == "Painel admin NICK HUB" then
loadstring(game:HttpGet("https://pastebin.com/raw/YcxTnL5J"))()
Window:Notify("✅ Painel executado!", 3)
else
Window:Notify("⚠️ Selecione um painel válido!", 3)
end
end
})
...
"Descobriram a source do nosso painel e vazaram",
"Infelizmente estamos trabalhando pra refazer o painel numa versão poderosa"
})
